           ...
           <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 col-xlg-5">
                    <div class="card card-hover">
                        <a href="{{route('leave')}}"><div class="box bg-info text-center">
                            <h1 class="font-light text-white"><i class="mdi mdi-collage"></i></h1>
                            <h6 class="text-white">Leave List</h6>
                        </div></a>
                    </div>
                </div>
                <!-- Column -->
                <div class="col-md-6 col-lg-5 col-xlg-5">
                    <a href="{{ route('leave.create')}}"><div class="card card-hover">
                        <div class="box bg-info text-center">
                            <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                            <h6 class="text-white">Apply leave</h6>
                        </div></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-body">
                            <h3 style="text-align: center;">Employee Progress</h3>
                            <div class="progress">
